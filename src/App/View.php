...
/**
 * Разумеется, т.к. у нас нет MVC, то и ничего общего с классическими вьюхами этот класс не имеет.
 * Здесь указаны методы, которые собирают и возвращают некоторых html-контент.
 *
 * @package App
 */
class View
